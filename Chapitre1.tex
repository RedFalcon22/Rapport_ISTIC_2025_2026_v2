...
% ── Module 1 : Noa ────────────────────────────────────────────────────────────
\subsection{Module 1 — assistant Noa}
...
Le \textit{assistant technique} est un assistant destiné aux utilisateurs internes de la plateforme.
...
\hline
BNF-07 & Multilingue
        & L'interface et les réponses sont disponibles en français, en anglais et en arabe, avec détection automatique de la langue. Le assistant émotionnel étend ce support au darija tunisien et au code-switching arabo-français. \\
\hline
BNF-08 & Robustesse
...
Il interagit avec le \textit{assistant technique} pour obtenir de l'aide sur
...
\subsection{Noa et assistant technique (stéréotype «Actor»)}

Noa et le \textit{assistant technique} sont les deux assistants virtuels du système.
...
Le assistant émotionnel est un composant intelligent de la plateforme Netethic.
...
La Figure~\ref{fig:use_case} présente le système global : le visiteur interagit avec Noa, l'utilisateur interne avec le \textit{assistant technique} et le assistant émotionnel, tandis que l'administrateur supervise l'ensemble et que le serveur LLM externe alimente tous les modules.
...
CU-03 & Poser une question (support interne)
       ...
       & L'utilisateur sélectionne une catégorie parmi les 11~modules, puis pose sa question.
         Le assistant technique retourne une réponse ancrée dans la documentation. \\
\hline
