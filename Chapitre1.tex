...
L'organisation de Smart-Conseil favorise la collaboration entre ses membres.
Chaque équipier apporte son expertise, ce qui encourage l'innovation collective.
Dans cet environnement dynamique, les idées se transforment en produits professionnels et compétitifs.
...
Notre projet s'inscrit dans la plateforme \textbf{Netethic} et a pour objectif d'enrichir cette dernière de quatre modules intelligents et complémentaires basés sur l'intelligence artificielle.
...
\begin{enumerate}
    ...
    \item \textbf{Assistant de support interne :} un assistant destiné au personnel des établissements utilisant Netethic.
          Il répond aux questions sur les fonctionnalités de la plateforme, gère les demandes de rendez-vous de support et recueille les signalements de dysfonctionnements techniques.
