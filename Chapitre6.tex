...
La pile logicielle complète est décrite au Chapitre~3 (Tableau~\ref{tab:env_logiciel}).
L'outil supplémentaire utilisé pour cette phase est le framework d'évaluation
\textbf{RAGAS}~0.1 avec le juge LLM Groq API (\texttt{llama-3.3-70b-versatile}).
...
\begin{tabular}{|l|c|c|}
\hline
\textbf{Configuration} & \textbf{Latence moyenne} & \textbf{Latence P99\footnote{P99 : 99\textsuperscript{e} percentile — latence dépassée par seulement 1\,\% des requêtes.}} \\
\hline
...
OWASP Top~10 for LLM Applications, couvrant les risques spécifiques
aux applications fondées sur des modèles de langage :
