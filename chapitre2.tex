...
\subsection{Noa et assistant technique}

L'assistant Noa et l'assistant technique sont les deux assistants virtuels du système.
Chacun orchestre de manière autonome son pipeline de traitement.

\subsection{assistant émotionnel}

L'assistant émotionnel est un composant intelligent de la plateforme Netethic.
...
Il orchestre de manière autonome son pipeline de traitement.

\subsection{Classificateur de harcèlement}
...
Il conduit de manière autonome son pipeline d'analyse.
...
L'utilisateur interne est l'acteur principal du \textit{assistant technique} :
...
Les sept acteurs du système ont été identifiés, incluant les assistants virtuels et les modules autonomes.
