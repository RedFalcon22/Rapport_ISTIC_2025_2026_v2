...
\HRule \\[0.4cm]
\textcolor{blue}{ \LARGE \bfseries Intégration d’agents intelligents dans une plateforme de détection du cyberharcèlement}\\[0.4cm] % Title of your document
\HRule \\[0.5cm]
...
%\vspace{0.5cm}
%\begin{center}
{Réalisé au sein de Smart-Conceil}\\[0.5cm]
%\smallskip
...
Prénom NOM, Enseignant, ISTIC\\
Serawork Wallelign, Smart-Conseil\\
Wassim Abbessi, ISTIC
\end{minipage}
