...
\begin{figure}[H]
\centering
\hspace*{-0.1\textwidth}\includegraphics[width=1.2\textwidth]{diagramme/12_composants_architecture.png}
...
\begin{itemize}
    ...
    \item \textbf{Base documentaire vectorielle (ChromaDB) :} Stocke les extraits de documents
          ...
          Chaque module possède sa propre collection : le module Noa et le Support Assistant
...
\caption{Diagramme de composants — Module Noa}
...
\caption{Diagramme de déploiement — Module Noa (stack Docker Compose)}
...
La Figure~\ref{fig:composants_support} illustre l'architecture interne du Support Assistant et les interactions entre ses composants.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{diagramme/19_composants_support.png}
\caption{Diagramme de composants — Module Support Assistant}
\label{fig:composants_support}
\end{figure}

\subsection{Diagramme de déploiement}

La Figure~\ref{fig:deploiement_support} présente la stack Docker Compose du Support Assistant avec ses conteneurs et leurs interconnexions.

\begin{figure}[H]
\centering
\hspace*{-0.1\textwidth}\includegraphics[width=1.2\textwidth]{diagramme/15_deploiement_support.png}
\caption{Diagramme de déploiement — Module Support Assistant (stack Docker Compose)}
...
La Figure~\ref{fig:etat_support_pipeline} représente le cycle de vie du Support Assistant, du démarrage jusqu'à la génération de la réponse, incluant les flux de repli.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagramme/07a_etat_support_pipeline.png}
\caption{Diagramme d'état-transition — Support Assistant : pipeline et flux de repli}
...
La Figure~\ref{fig:composants_emotionnel} illustre l'architecture en couches du module de soutien émotionnel et les interactions entre ses composants.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{diagramme/20_composants_emotionnel.png}
\caption{Diagramme de composants — Module de soutien émotionnel}
\label{fig:composants_emotionnel}
\end{figure}

\subsection{Diagramme de déploiement}

La Figure~\ref{fig:deploiement_emotionnel} présente la stack Docker Compose du module de soutien émotionnel avec ses conteneurs et leurs interconnexions.

\begin{figure}[H]
\centering
\hspace*{-0.1\textwidth}\includegraphics[width=1.2\textwidth]{diagramme/16_deploiement_emotionnel.png}
\caption{Diagramme de déploiement — Module de soutien émotionnel (stack Docker Compose)}
...
La Figure~\ref{fig:seq_emotionnel} détaille les interactions entre les composants lors du traitement d'un message par l'assistant émotionnel.
...
La Figure~\ref{fig:etat_emotionnel} représente les états possibles du module au cours d'une session, incluant les chemins de blocage, de crise et nominal.
...
11~collections pour le Support Assistant) et validé la stratégie hybride
