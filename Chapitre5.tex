...
Noa et le assistant technique — cette phase consiste en la construction
...
Le assistant émotionnel, dont l'architecture repose exclusivement sur
...
\subsection{Module assistant technique — documentation interne}

\paragraph{Sources documentaires}\mbox{}\newline

La base de connaissances du assistant technique est constituée à partir
...
La collection ChromaDB du assistant technique est organisée en onze sous-collections,
...
parent-enfant pour Noa, et les documents du assistant technique ont été organisés
