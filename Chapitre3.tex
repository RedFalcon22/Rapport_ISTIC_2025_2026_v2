...
L'architecture RAG a été retenue pour les modules Noa et assistant technique.
...
Le assistant émotionnel, en revanche, ne dispose pas de base documentaire fixe :
...
selon les critères pertinents pour le assistant émotionnel.
...
Contrairement aux modules Noa et assistant technique,
...
Les modules conversationnels du projet (Noa, assistant technique, soutien émotionnel)
...
\hline
Backend Python  & Python               & 3.11             & Langage principal — modules Noa et assistant technique \\
\hline
...
Six axes ont été étudiés : les assistants conversationnels,
la recherche documentaire intelligente, les modèles de génération de langage,
le soutien émotionnel par intelligence artificielle,
la détection automatique du harcèlement,
et l'orchestration des pipelines conversationnels.
L'architecture RAG, le modèle Mistral-7B déjà hébergé sur kaisens.fr,
ChromaDB, LangChain, le LLM conversationnel avec profil utilisateur persistant,
et l'ancrage juridique forment un ensemble cohérent, adapté aux contraintes du projet :
confidentialité des données, qualité en français,
absence de corpus étiqueté, déploiement autonome et maîtrise des coûts d'infrastructure.
