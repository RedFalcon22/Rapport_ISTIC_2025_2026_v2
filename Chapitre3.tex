...
À partir des années 2010, des plateformes comme Dialogflow ont introduit
...
Le modèle d'encodage retenu est \texttt{paraphrase-multilingual-MiniLM-L12-v2} \cite{sbert},
pour sa compatibilité française et anglaise et sa légèreté
(fonctionne sans processeur graphique).
La base vectorielle retenue est \textbf{ChromaDB} \cite{chromadb},
pour sa persistance locale, sa légèreté et son intégration native avec LangChain.
