...
Il est organisé en quatre axes : les assistants conversationnels,
...
\hline
Architecture chatbot & RAG & Fiabilité, contrôle du périmètre \\
...
L'architecture RAG, le modèle Mistral-7B, ChromaDB et l'ancrage juridique
